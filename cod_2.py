...
cal, fs = sf.read('calibracion_prueba.wav') #importo senal de calibracion y su frecuencia de muestreo
ruido, fs = sf.read('ruido_fondo_prueba.wav') #importo ruido de fondo y su frecuencia de muestreo
